...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.setup = function() {
      ...
      if (this.is_rtl) this.faraway='right';
      else this.faraway='left';
    };
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        container_div.html('<ul class="chzn-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="chzn-drop" style="'+this.faraway+':-9000px;"><ul class="chzn-results"></ul></div>');
      } else {
        container_div.html('<a href="javascript:void(0)" class="chzn-single"><span>' + this.default_text + '</span><div><b></b></div></a><div class="chzn-drop" style="'+this.faraway+':-9000px;"><div class="chzn-search"><input type="text" autocomplete="off" /></div><ul class="chzn-results"></ul></div>');
      }
    ...
    Chosen.prototype.results_show = function() {
      ...
      this.dropdown.css("top",dd_top + "px").css(this.faraway,'0px');
    ...
    Chosen.prototype.results_hide = function() {
      ...
      this.result_clear_highlight();
      this.dropdown.css(this.faraway,"-9000px");
    ...
    Chosen.prototype.search_field_scale = function() {
      ...
      if (this.is_multiple) {
        h = 0;
        w = 0;
        style_block = "position:absolute; "+this.faraway+": -1000px; top: -1000px; display:none;";
