...
CREATE TABLE IF NOT EXISTS `PUT_TBL_LOG_HERE` (
  ...
  `ex` varchar(250) COLLATE PUT_DB_COLLATION_HERE DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `PUT_TBL_INFO_HERE` (
  ...
  `tname` varchar(36) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '',
  `fname` varchar(36) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '',
  `class` varchar(36) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '',
  `label` varchar(250) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '',
  ...
  `default` varchar(250) COLLATE PUT_DB_COLLATION_HERE DEFAULT NULL,
  `allowed1` varchar(250) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '',
  `allowed2` varchar(250) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '',
  `allowed3` varchar(250) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '',
  `allowed4` varchar(250) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '',
  `comment1` varchar(500) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '',
  `comment2` varchar(500) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '',
  `comment3` varchar(500) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '',
  `actions1` varchar(500) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '',
  `actions2` varchar(500) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '',
  `actions3` varchar(500) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `PUT_TBL_USERS_HERE` (
  ...
  `group` varchar(60) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '' COMMENT 'role, group for permissions',
  ...
  `email` varchar(100) COLLATE PUT_DB_COLLATION_HERE NOT NULL DEFAULT '',
